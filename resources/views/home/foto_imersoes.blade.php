        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                   ...
                   <div class="col-xs-12">
                    <h4>Foto atual:</h4>
                    @if (isset($FotosHome->fotoImersoes)) 
                    <div class="col-xs-12">
                    ...
                    <div class="col-xs-12">
                        <img id="foto_servico" class="foto_servico" src="{{$FotosHome->fotoImersoes->urlCloudinary}}" alt="Foto atual de Imersoes">
                    </div>
