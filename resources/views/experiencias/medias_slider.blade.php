...
@forelse ($experiencia->mediasSlider as $Media)

    <li class="col-xs-12 col-sm-6 col-md-3 media-item">
    @if ($Media && $Media['type'] == 'photo')
        <img class="img-media-slider" src="//res.cloudinary.com/vivala/image/upload/c_scale,h_120/{{ $Media['code'] }}" alt="Foto da {{ $experiencia->titulo}}">
        <p>
...
@empty
    ...
    <li> Essa experiência não possui nenhuma foto ou video </li>
